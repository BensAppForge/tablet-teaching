...
Each test document contains a `questions` subcollection. Each question document has a `type` field that determines its structure.
...
*This document will be updated as the schema evolves.*
